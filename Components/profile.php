    ...
    <body>
                        ...
                        <div class=" col">
                            <div class="d-flex row">
                                <div>
                                    ...
                                    <button class="rounded-circle edit" onclick="document.getElementById('cred-update').style.display = 'flex';" onclick="cred()">
        ...
        <div id="cred-container" class="qcardcontainer bg-dark">
            <div class="overlay d-flex justify-content-center align-items-center">
                ...
                <div class="card w-50 px-5 py-4" id="cred-update">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="study">Study at</label>
                            <input type="text" class="form-control" id="study" >
                        </div>
                        
                        <div class="form-group">
                            <label for="live">Lives at</label>
                            <input type="text" class="form-control" id="live" >
                        </div>
